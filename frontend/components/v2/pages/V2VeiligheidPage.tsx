    ...
    return (
        <main className="flex-grow pt-40 pb-24 bg-v2-bg overflow-hidden relative">
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-24 relative">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                    <div className="max-w-3xl">
                        <div className="flex items-center gap-3 mb-6">
                            <span className="text-[10px] font-mono text-v2-accent-alt font-black uppercase tracking-widest bg-v2-accent-alt/10 px-2 py-0.5 border border-v2-accent-alt/30 rounded-sm">
                                Protocol_v4.2
                            </span>
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-v2-primary font-mono tracking-tighter mb-8 uppercase leading-none">
                            AI Security <br />
                            <span className="text-v2-accent-alt">Architecture</span>
                        </h1>
                        <p className="text-xl text-v2-text-secondary font-medium leading-relaxed max-w-2xl">
                            Innovatie mag nooit ten koste gaan van databeveiliging. Wij engineeren volgens een strikt 'Privacy by Design' framework, waarbij elke operatie audit-ready is.
                        </p>
                    </div>

                    {/* Status Dashboard Component */}
                    <div className="p-6 bg-v2-surface border border-v2-border/50 rounded-lg shadow-2xl space-y-4 min-w-[280px]">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-between text-[10px] font-mono">
                                ...
                                <span className="font-black text-v2-accent">ACTIVE</span>
                            </div>
                            <div className="flex justify-between text-[10px] font-mono">
                ...
                {/* Main Security Grids */}
                <div className="grid md:grid-cols-2 gap-px bg-v2-border/30 border border-v2-border/30 rounded-lg overflow-hidden shadow-2xl">
                    {/* Data Sovereignty */}
                    <SecurityModule
                    ...
                    {/* Open Stack */}
                    <SecurityModule
                        title="Open Stack Tech"
                        subtitle="Transparant & Toekomstvast"
                        description="Gebouwd op bewezen Open Source platformen (Kubernetes & Nvidia frameworks) om vendor lock-ins te vermijden."
                        ...
                        points={[
                            ...
                            { label: 'VELOCITY', text: 'Wekelijkse updates in performance en veiligheid door de global enterprise community.' }
                        ]}
                    />
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-8 mt-24">
                <div className="bg-v2-primary p-1 rounded-lg border border-white/5">
                    <div className="bg-v2-primary p-12 lg:p-16 rounded-lg relative overflow-hidden flex flex-col lg:flex-row gap-12 items-center">
                        <div className="flex-1 space-y-6">
                            <h2 className="text-3xl md:text-5xl font-black text-white font-mono tracking-tighter uppercase">
                                Compliance & <br />
                                <span className="text-v2-accent">Samenwerking</span>
                            </h2>
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 w-full lg:w-auto">
                            <div className="bg-white/5 border border-white/10 p-8 rounded-lg space-y-4">
                                ...
                                <p className="text-xs text-white/50 leading-relaxed">
                                    Conform ISO 27001 en NEN 7510. Certificeringstraject is actief.
                                </p>
                            </div>
                            <div className="bg-white/5 border border-white/10 p-8 rounded-lg space-y-4">
                                ...
                                <p className="text-xs text-white/50 leading-relaxed">
                                    Proactieve input voor Data Protection Impact Assessments beschikbaar.
                                </p>
                            </div>
                        </div>
                    </div>
